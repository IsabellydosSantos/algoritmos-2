def substituir(arquivo1, arquivo2, string1, string2):
    try:
        with open(arquivo1, 'r', encoding='utf-8') as original:
            conteudo = original.read()
        conteudo_mod = conteudo.replace(string1, string2)

        with open(arquivo2, 'w', encoding='utf-8') as modif:
...
string1 = input("Insira a primeira string: ").strip()
string2 = input("Insira a segunda string: ").strip()
